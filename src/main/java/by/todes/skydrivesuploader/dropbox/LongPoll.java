...
public class LongPoll {
     ...
     */
    public  void longpoll(DbxClientV2 dbxClient, String path) throws IOException {
        ...
        //
        StandardHttpRequestor.Config.Builder conf=StandardHttpRequestor.Config.builder();
            if (Settings.instance().useProxy){
                conf.withProxy(Settings.instance().getProxy());
            }    
//        StandardHttpRequestor.Config config = conf.build();
        StandardHttpRequestor.Config longpollConfig = conf
